...
$topcode = get_query_val('fn_open','term',"`type`= $type order by `term` desc limit 1");
  ...
  $url = 'http://stitej.com/ap1/azxy10.php?id=123A3S56Q1GGSGACSADGASDGAQLBQIA';
...
if($term != '' && $topcode<$term){
   insert_query('fn_open', array('term' => $term, 'code' => $haoma, 'time' => $opentime, 'type' => $type, 'next_term' => $next_term, 'next_time' => $next_time));
   AZXY10_jiesuan();
