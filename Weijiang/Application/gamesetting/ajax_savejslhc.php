...
if($_GET['form'] == 'form1'){
    ...
    update_query("fn_lottery14", array("shengxiao" => $shengxiao, "shengxiaonian" => $shengxiaonian, "da" => $da, 'xiao' => $xiao, 'dan' => $dan, 'shuang' => $shuang, 'hongbo' => $hongbo, 'lanbo' => $lanbo, 'lvbo' => $lvbo, 'haoma' => $haoma, 'zhengma'=>$zhengma, 'xiao2' => $xiao2, 'xiao3' => $xiao3, 'xiao4' => $xiao4, 'xiao5' => $xiao5, 'xiao2nian' => $xiao2nian, 'xiao3nian' => $xiao3nian, 'xiao4nian' => $xiao4nian, 'xiao5nian' => $xiao5nian, 'zheng2' => $zheng2, 'zheng3' => $zheng3, 'zheng4' => $zheng4), array('roomid' => $_SESSION['agent_room']));
    echo '<script>alert("保存成功~感谢使用!"); window.location.href="/Weijiang/index.php?m=g_setting&g=jslhc";</script>';
