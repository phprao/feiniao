    ...
    <div class="back-main">
        <form method="post" id="loginform" action="web_login.php?type=user">
            <ul class="home_url">
                ...
                <li>
                    <div class="inputtxt"><input id="loginuser" name="loginuser" type="text" placeholder="用户名" title="用户名"></div>
                </li>
                <li>
                    <div class="inputtxt"><input id="loginpass" type="password" name="loginpass" placeholder="密码" title="密码"></div>
                </li>
                <li><input type="checkbox" id="check">是否记住密码<br></li>
                <li>
                    <a href="javascript:void(0);" id="btsubmit">账户登录</a>
                    <br />
                    <a href="/web_reg.php" id="btsubmit">账户注册</a>
