...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="/Style/Error/images/favicon.ico" type="image/x-icon">
    <title>:: Startr :: Free Startup landing page</title>
    
    <!-- style -->
    <link href="/Style/Error/css/style.css" rel="stylesheet" type="text/css">
    <!-- Bootstrap -->
    <link href="/Style/Error/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <!-- carousel -->
    <link href="/Style/Error/css/owl.carousel.css" rel="stylesheet" type="text/css">
    <!-- responsive -->
    <link href="/Style/Error/css/responsive.css" rel="stylesheet" type="text/css">
    <!-- font-awesome -->
    <link href="/Style/Error/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!-- font-awesome -->
    <link href="/Style/Error/css/animate.min.css" rel="stylesheet" type="text/css">
    <link href="/Style/Error/css/popup.css" rel="stylesheet" type="text/css">
	<?php $txt = $_SESSION['error_room'];
?>
  </head>
    	...
    	<header role="header" class="header-top" id="headere-top">
                ...
                <div class="container">
                    ...
                    <hgroup class="row">
                        ...
                        <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                            <h1>
                                <a href="#headere-top" title="Rooky"><img src="/Style/Error/images/logo.png" alt="Rooky" title="Rooky"/></a>
                            </h1>
                        </div>
                        <!-- logo -->
                        <!-- nav -->
            ...
            <!-- banner Text --> 
                 <section class="text-center">
                    ...
                    <h2><?php if($txt != '')echo '访问错误ID:' . $txt;
?></h2>
                    <p>Perfect and awesome theme to present your product or service</p>
            ...
            <!-- banner image -->
        	<figure>
            	<div class="parallax-window item tp-banner-container" data-parallax="scroll" data-image-src="/Style/Error/images/bg.jpg"></div>
            </figure>
            <!-- banner image -->
        </header>
    <!-- header -->
    	...
    	<main role="main" id=" main-wrapper">
            	...
            	<div class="container">
                	<ul class="row">
                        ...
                        <li class="col-xs-4 col-sm-3 col-md-2 col-lg-2 ">
                        	<a href="#"><img src="/Style/Error/images/logoes/logoes-1.png" alt="" class="img-responsive"/></a>
                        </li>
                        <li class="col-xs-4 col-sm-3 col-md-2 col-lg-2">
                        	<a href="#"><img src="/Style/Error/images/logoes/logoes-2.png" alt="" class="img-responsive"/></a>
                        </li>
                        <li class="col-xs-4 col-sm-3 col-md-2 col-lg-2">
                        	<a href="#"><img src="/Style/Error/images/logoes/logoes-3.png" alt="" class="img-responsive"/></a>
                        </li>
                        <li class="col-xs-4 col-sm-3 col-md-2 col-lg-2">
                        	<a href="#"><img src="/Style/Error/images/logoes/logoes-4.png" alt="" class="img-responsive"/></a>
                        </li>
                        <li class="col-xs-4 col-sm-3 col-md-2 col-lg-2">
                        	<a href="#"><img src="/Style/Error/images/logoes/logoes-5.png" alt="" class="img-responsive"/></a>
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section class="section-two" id="section-two">
                ...
                <section>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <figure class="row" style="background-image:url('/Style/Error/images/bg2.jpg')"></figure>
                    </div>
                 </section>
                <!-- image-content -->
                <div class="clearfix"></div>
                 ...
                 <section>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                    	<figure class="row" style="background-image:url('/Style/Error/images/bg3.jpg')"></figure>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                    	<article>
            	...
            	<div class="container">
                    ...
                    <div class="subscribe-form">
                        <div class="ntify_form">
                            <form method="post" action="/Style/Error/php/subscribe.php" name="subscribeform" id="subscribeform">
            ...
            <section class="section-six" id="section-six">
            	<div class="container">
                    ...
                    <div class="contact-form">
                        <div id="message"></div>
                                <form method="post" action="/Style/Error/php/contactfrom.php" name="cform" id="cform">
           ...
           <footer role="footer" class="footer text-center">
           		<div class="container">
                    ...
                    <!-- nav -->
                    <p class="copy">&copy; 2016 Sartr. All rights reserved. More Templates - Collect from Xsoul</p>
                </div>
           </footer>
           <!-- footer -->
    ...
    <script src="/Style/Error/js/jquery.min.js" type="text/javascript"></script>
    
	<script src="/Style/Error/js/parallax.min.js" type="text/javascript"></script>
	<script type="text/javascript">
    	$('.parallax-window').parallax({});
    </script>
    <script src="/Style/Error/js/main.js" type="text/javascript"></script>
	<script src="/Style/Error/js/owl.carousel.js" type="text/javascript"></script>
    <script type="text/javascript" src="/Style/Error/js/jquery.mb.YTPlayer.js"></script>
	<script type="text/javascript" src="/Style/Error/js/video.js"></script>
    <script src="/Style/Error/js/custom.js" type="text/javascript"></script>
	<script src="/Style/Error/js/jquery.magnific-popup.min.js" type="text/javascript"></script>
	<script src="/Style/Error/js/jquery.contact.js" type="text/javascript"></script>
    <script src="/Style/Error/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="/Style/Error/js/html5shiv.min.js" type="text/javascript"></script>
  </body>
</html>